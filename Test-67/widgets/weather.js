...
import { getWeatherIconSVG, createSVGElement } from '../icons.js';
...
function renderWeather(data, source = 'live') {
  ...
  const iconSVG = getWeatherIconSVG(current.weatherDesc[0].value);
  weatherIcon.innerHTML = '';
  const svgElem = createSVGElement(iconSVG);
  svgElem.style.width = '100%';
  svgElem.style.height = '100%';
  svgElem.style.color = 'currentColor';
  weatherIcon.appendChild(svgElem);
