...
import { icons, createSVGElement } from './icons.js';
...
function setTheme(theme) {
  ...
  if (themeToggle) {
    ...
    const icon = createSVGElement(theme === 'dark' ? icons.sun : icons.moon);
    ...
    themeToggle.appendChild(document.createTextNode(theme === 'dark' ? '  Светлая' : '  Тёмная'));
